...
import { Truck, ShoppingCart, Calendar, Users, TrendingUp, History, PanelRightClose, PanelRightOpen } from "lucide-react";
    ...
    <div className="flex gap-6 h-full">
      <div className="flex-1 max-w-4xl mx-auto py-8 px-4 space-y-8 min-w-0">
        <div className="space-y-1">
          ...
          <p className="text-sm text-[#5a5a6e]">Panel de control del m&oacute;dulo de compras</p>
        </div>
            ...
            <div className="px-4 pb-4 space-y-3">
              ...
              <div className="flex items-center justify-between rounded-lg bg-[#111114] px-4 py-3 border border-[#1e1e24]">
                <div className="flex items-center gap-2 text-amber-400">
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-wider text-[#5a5a6e]">&Uacute;ltima compra</span>
                </div>
                <span className="text-sm font-bold text-white">--</span>
              </div>
            </div>
          ...
          <div className="rounded-xl border border-[#1e1e24] bg-[#0d0d0f] overflow-hidden">
            ...
            <div className="px-4 pb-4 space-y-3">
              <div className="rounded-lg bg-[#111114] px-4 py-3 border border-[#1e1e24]">
                <h3 className="text-xs font-medium text-white/60 mb-2">&Uacute;ltimas compras</h3>
                <p className="text-[11px] text-white/30">Sin datos disponibles</p>
              </div>
              <div className="rounded-lg bg-[#111114] px-4 py-3 border border-[#1e1e24]">
                <h3 className="text-xs font-medium text-white/60 mb-2">Productos m&aacute;s comprados</h3>
                <p className="text-[11px] text-white/30">Sin datos disponibles</p>
              </div>
            </div>
          </div>
